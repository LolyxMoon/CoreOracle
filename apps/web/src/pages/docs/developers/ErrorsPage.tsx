    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-xl border border-border bg-muted/20">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <a href="https://x.com/CoreOracleAI" target="_blank" rel="noopener noreferrer" className="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors">
