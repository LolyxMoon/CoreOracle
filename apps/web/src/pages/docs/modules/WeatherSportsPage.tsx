  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4 pt-8 border-t border-border">
        ...
        <Callout type="info">
          <strong>Interested in Sports Oracles?</strong> Follow us on <a href="https://x.com/CoreOracleAI" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">X</a> to be notified when the Sports module launches
